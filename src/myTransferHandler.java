...
public class myTransferHandler extends TransferHandler {
    ...
    protected Transferable createTransferable(JComponent source) {
        Transferable t = new  StringSelection(source.toString());
    ...
    protected void exportDone(JComponent source, Transferable data, int action) {
        String movedItem = data.toString();
        if (action == TransferHandler.MOVE) {
            System.out.println("MOVE");
        }
        //Transferable contents= (Transferable) getToolkit().getSystemClipboard().getContent(null);
        System.out.println("Ended= "+source + " content="+data);
    }
